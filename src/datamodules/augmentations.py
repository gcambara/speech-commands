...
from audiomentations import Compose, AddGaussianNoise, TimeStretch, PitchShift, Resample, Shift
...
class WaveformAugmentations(nn.Module):
    ...
    def build_augmentations(self, cfg):
        ...
        if (cfg.time_shift_p > 0.0) and (cfg.time_shift_range > 0.0):
            ...
            augmentations.append(Shift(min_fraction=-fraction, max_fraction=fraction, p=cfg.time_shift_p))
